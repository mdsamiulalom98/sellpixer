                        ...
                        <tbody>
                            @foreach ($show_data as $key => $value)
                                <tr>
                                    ...
                                    <td>{{ $value->shipping ? $value->shipping->phone : '' }} <button class="fraud_checker btn btn-xs rounded-pill btn-primary" data-id="{{$value->id }}" data-bs-toggle="modal" data-bs-target="#fraud_checker_modal">Check Fraud</button></td>
